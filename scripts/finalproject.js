/*
	...
	date:   5-jul-2021
	notes:	ryan carswell comp 2132 interactive scripts
*/
...
function begin(){
    // fades out welcome screen and brings in the game screen
...
function playRoundOfDiceGame()
{
    ...
    // allow shake/dice-roll animation to take place before showing results
    setTimeout(function(){
        // stop shake
...
/**
 * updates scores, summary, and round info
 * @param {*} playerRoundScore the player's score for a round
 * @param {*} computerRoundScore the computer's score for a round
 */
...
{
    // set dice images for given rolls
...
/**
 * determines the winner, generates the summary text, and plays a sound depending on who wins
 * @param {*} player1TotalScore player one's total score 
 * @param {*} player2TotalScore player two's (computer's) total score
 */
function generateWinnerSummary(player1TotalScore, player2TotalScore)
{
    ...
    else if(winnerSummary.includes("The computer won"))
    {
        playLoseSound();
    }
    else
...
/**
 * toggles mute on background music
 */
